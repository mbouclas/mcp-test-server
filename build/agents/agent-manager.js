...
export class AgentManager {
     ...
     */
    async routeMessage(message, conversationId, explicitAgent) {
        let selectedAgent;
        let routing;
        ...
        try {
            ...
            const result = await this.agents[selectedAgent].processRequest(message, conversationId);
            return {
     ...
     */
    async handleGeneralRequest(message, conversationId, routing) {
        try {
     ...
     */
    clearAgentContext(agentName, conversationId) {
